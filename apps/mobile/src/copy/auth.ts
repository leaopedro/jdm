export const authCopy = {
  ...
  signup: {
    ...
    dobHint: 'Você precisa ter 18 anos ou mais para usar o JDM Experience.',
    dobInvalid: 'Data inválida. Use o formato DD/MM/AAAA.',
    submit: 'Criar conta',
    ...
    termsClause:
      'O JDM Experience é destinado exclusivamente a pessoas com 18 anos completos ou mais. Ao criar uma conta, você declara que tem 18 anos ou mais e capacidade civil plena para contratar os serviços oferecidos.',
    haveAccountPrefix: 'Já tem conta? ',
    haveAccountLink: 'Entrar',
    underageTitle: 'Conta indisponível',
    underageBody:
      'Você precisa ter 18 anos ou mais para criar uma conta no JDM Experience. Volte quando completar 18 anos — você é bem-vindo(a).',
    underageDismiss: 'Entendi',
  },
  forgot: {
